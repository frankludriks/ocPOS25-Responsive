...
<body onload="<?php echo($Onload); ?>">
 ...
 <td width="100%" align="center">
  <b><?php echo ENTER_CASH . ' (' . $RemainingTotal . ') '; ?></b><br><br>
 </td>
 </tr>
 <tr>
 <td width="100%" align="center">
 <form name="CashForm" method="post" class="form-inline">
  <div class="form-group">
    <label class="sr-only" for="exampleInputAmount">Amount</label>
    <div class="input-group">
      <div class="input-group-addon"><?php echo $default_currency_symbol; ?></div>
      <input autofocus type="text" class="form-control" name="Cash" id="exampleInputAmount" placeholder="Amount">
 ...
 <td width="100%" class="tdBlue" align="center">
   <?php if($_SESSION['CurrentOrderIndex'] == -1){ ?>
	  <a href="#" title="<?php echo PROCESS_ORDER_BUTTON_TITLE; ?>" onclick="this.blur(); document.CashForm.submit();" class="btn btn-success btn-default disabled" role="button"><?php echo PROCESS_ORDER; ?></a>
      
  <?php } else { ?>
      	  <a href="#" title="<?php echo PROCESS_ORDER_BUTTON_TITLE; ?>" onclick="this.blur(); document.CashForm.submit();" class="btn btn-success btn-default" role="button"><?php echo PROCESS_ORDER; ?></a>
   <?php } ?>
